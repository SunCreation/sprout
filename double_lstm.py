...
def create_model():
    ...
    x3 = x3 + x2
    l1 = LSTM(64)(x3)
    out = Dense(3, activation='relu')(l1)
...
# 학습
hist = model.fit(train_x, train_y, batch_size=32, epochs=120, validation_data=(val_x, val_y), callbacks=[checkpointer])
